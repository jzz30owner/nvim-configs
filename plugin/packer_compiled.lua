...
_G.packer_plugins = {
  ...
  ["move.nvim"] = {
    loaded = true,
    path = "/home/user/.local/share/nvim/site/pack/packer/start/move.nvim",
  ...
  ["nvim-gdb"] = {
    loaded = true,
    path = "/home/user/.local/share/nvim/site/pack/packer/start/nvim-gdb",
  ...
  ["vim-cmake"] = {
    loaded = true,
    path = "/home/user/.local/share/nvim/site/pack/packer/start/vim-cmake",
